...
- Показывает сохранённые Plex-ряды сразу и обновляет устаревшие данные в фоне, не задерживая повторный запуск Lampa.
...
- Если Lampa держит старый кэш: `https://m3dfatboi.github.io/lampa-plex/plex-watchlist.js?v=0.5.20`
