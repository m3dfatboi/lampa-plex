(function () {
    ...
    function registerPlexRows() {
        ...
        Lampa.ContentRows.add({
            ...
            call: function (params) {
                ...
                return safeContentRow(function (call) {
                    loadPlexShowHistory(function (cards) {
                        call(makePlexRow('Вы смотрели', cards));
                    }, function () {
                        call();
                    });
    ...
    function uniqueShowHistoryItems(items) {
        var out = [];
        var seen = {};
        ...
        return out.slice(0, PLEX_ROW_SIZE);
    }
    ...
    function hydratePlexShowHistoryItems(items, success, fail) {
        ...
        preparePlexItems(candidates, {
            ...
            var shows = uniqueShowHistoryItems(prepared);
    ...
    function loadPlexShowHistory(success, fail) {
        loadProfileWatchHistory(function (items) {
            hydratePlexShowHistoryItems(items, success, function () {
                loadPlexShowHistoryFallback(success, fail);
            });
        }, function () {
            loadPlexShowHistoryFallback(success, fail);
        }, {
            first: PLEX_ROW_SIZE * 3
        });
    }
